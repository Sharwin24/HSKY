...
void setDrive(int left, int right) {
	driveLeftBackBack.moveVelocity(200 * left);
	driveLeftBackFront.moveVelocity(200 * left);
	driveLeftFront.moveVelocity(200 * left);

	driveRightBackBack.moveVelocity(200 * right);
	driveRightBackFront.moveVelocity(200 * right);
	driveRightFront.moveVelocity(200 * right);
}
